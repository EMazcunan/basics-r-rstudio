...
\begin{center}\includegraphics[width=1\linewidth]{basics-R-RStudio_files/figure-latex/unnamed-chunk-23-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{basics-R-RStudio_files/figure-latex/unnamed-chunk-27-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{basics-R-RStudio_files/figure-latex/unnamed-chunk-28-1} \end{center}
...
Está disponible en la siguiente URL: \url{https://raw.githubusercontent.com/EMazcunan/basics-r-rstudio/master/data/temperaturas.csv}.

Descárgalo usando el enlace anterior y guárdalo en una carpeta de nombre \texttt{data} en el directorio del archivo R Markdown con el que estés trabajando.

\hypertarget{archivos-locales}{%
\subsection{Archivos locales}\label{archivos-locales}}
...
\hypertarget{archivos-en-red}{%
\subsection{Archivos en red}\label{archivos-en-red}}

Antes hemos realizado la descarga del archivo de datos de forma manual. Conociendo su URL, también, podríamos haberlo hecho desde \textsf{R}, con la función \texttt{download.file()}:
...
\begin{center}\includegraphics[width=1\linewidth]{basics-R-RStudio_files/figure-latex/unnamed-chunk-32-1} \end{center}
...
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{scale\_y\_continuous}\NormalTok{(}\AttributeTok{breaks =} \FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{5}\NormalTok{,}\DecValTok{35}\NormalTok{,}\DecValTok{5}\NormalTok{)) }\SpecialCharTok{+} 
    \FunctionTok{labs}\NormalTok{(}
...
\begin{center}\includegraphics[width=1\linewidth]{basics-R-RStudio_files/figure-latex/unnamed-chunk-34-1} \end{center}
