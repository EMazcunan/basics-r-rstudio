...
Está disponible en la siguiente URL: <https://raw.githubusercontent.com/EMazcunan/basics-r-rstudio/master/data/temperaturas.csv>.

Descárgalo usando el enlace anterior y  guárdalo en una carpeta de nombre `data` en el directorio del archivo R Markdown con el que estés trabajando.
...
Antes hemos realizado la descarga del archivo de datos de forma manual. Conociendo su URL, también, podríamos haberlo hecho  desde `r R()`, con la función `download.file()`:
